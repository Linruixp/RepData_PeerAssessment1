...
```
#### The mean total number of steps taken each day is `r round(mean_perday)`, the median is `r median_perday`.  
...
```
#### The interval of `r interval_max` contains the maximum number of steps on average.
...
```
#### The total number of rows with missing values is `r nrow_withNAs`.  
...
```
#### The mean total number of steps taken per day is `r mean_perday_imputed`, the median is `r median_perday_imputed`.
